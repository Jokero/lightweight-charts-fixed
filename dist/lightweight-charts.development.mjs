/*!
 * @license
 * TradingView Lightweight Charts™ v4.1.6-dev+202406111743
...
class HorizontalLineRenderer extends BitmapCoordinatesPaneRenderer {
    ...
    _internal_hitTest(x, y) {
        ...
        if (y >= itemY - lineWidth - 0 /* Constants.HitTestThreshold */ && y <= itemY + lineWidth + 0 /* Constants.HitTestThreshold */) {
            return {
